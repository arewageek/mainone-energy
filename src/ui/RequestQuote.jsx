        ...
        <div className="w-full md:w-[80%] px-10 mx-auto flex justify-between items-center flex-col md:flex-row space-y-10 lg:space-y-0">
          <div className="w-full lg:w-3/5 md:px-10 py-5">
            <form action="#">
              <div className="w-full h-full bg-white text-gray-800 rounded-2xl px-5 md:px-[30pt] py-[50pt] flex flex-col space-y-3">
                ...
                <div className="flex flex-wrap space-y-8 flex-col">
                  <div className="w-full flex flex-wrap md:flex-row space-y-8 md:space-y-0 justify-between">
          ...
          <div className="w-full lg:w-2/5">
            <div className="w-full">
              ...
              <div className="my-5">
                <a className="px-6 py-5 w-fit flex justify-between items-center bg-green-200 text-green-900 text-md font-bold cursor-pointer border-2 border-green-200 hover:bg-green-700 hover:text-green-100 transition duration-300 space-x-3 group">
